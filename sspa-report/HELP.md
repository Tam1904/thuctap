...
* The following dependencies are not known to work with Spring Native: 'Spring Configuration Processor, MariaDB Driver,
...
```
$ docker run --rm -p 8080:8080 sspa-report:0.0.1-SNAPSHOT
```
