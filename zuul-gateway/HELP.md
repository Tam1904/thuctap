...
* The following dependencies are not known to work with Spring Native: 'Eureka Discovery Client, Spring Boot DevTools'.
...
```
$ docker run --rm -p 8080:8080 zuul-gateway:0.0.1-SNAPSHOT
```
